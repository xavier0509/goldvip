...
var loadStatus = 1;//未登录为0，登录为1，前往登录界面为2,退出动作时为3（防止退出时取到pause值误认为按主页键）.解除在登录界面按返回退掉bug
...
function sendHTTP1() {
    ...
    $.ajax({             
         ...
         // url: "http://121.43.118.111:8094/index.html",
...
function receive(data) {
    ...
    else 
    {
        ...
        document.getElementById("makesureDiv").removeEventListener("click",sendHTTP1 ,false);
    	getsuccess();
    }
}
